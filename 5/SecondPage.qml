    ...
    SilicaFlickable {
        ...
        Item {
              Timer {
                  ...
                  onTriggered: {
                      if (i % 20 == 1 || i % 20 == 2 || i % 20 == 3) {
                          cross = 1
                          green_light.state = "active"
                      }
                      else if (i % 20 == 11 || i % 20 == 12 || i % 20 == 13) {
                            cross = 2
                            green_light.state = "active"
                      }
                      else {
                      ...
                      if (i % 20 == 4 || i % 20 == 5 || i % 20 == 9 || i % 20 == 10) {
                          cross = 0
                          human.state = "Right"
                          yellow_light.state = "active"
                      }
                      else if ((i % 20 == 14 || i % 20 == 15 || i % 20 == 19 || i % 20 == 0)) {
                          cross = 0
                          human.state = "Left"
                          yellow_light.state = "active"
                      }
                      ...
                      if (i % 20 == 6 || i % 20 == 7 || i % 20 == 8 || i % 20 == 16 || i % 20 == 17 || i % 20 == 18) {
